...
def update_full_graph_params(
    ...
    # Backend selection can depend on the active vLLM configuration. Draft
    # graph updates run outside the model's normal config context, so restore
    # it while resolving the implementation used for capture and replay.

...
def chunk_local_cumsum_scalar_kernel(
    ...
    if HEAD_FIRST:
        ...
        b_s = tl.load(ptr_s, boundary_check=(0,), padding_option="zero").to(tl.float32)
    ...
    # The output defaults to FP32 even when the input is BF16. Block-pointer
    # stores require the value type to match the destination element type.
